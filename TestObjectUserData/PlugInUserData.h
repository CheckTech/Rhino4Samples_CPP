...
public:
  // Helper functions
  static bool HasPlugInUserData( const CRhinoObject* object );
  static bool AddPlugInUserData( CRhinoDoc& doc, const CRhinoObject* object, ON_3dPoint point, ON_wString string );
  static bool SetPlugInUserData( CRhinoDoc& doc, const CRhinoObject* object, ON_3dPoint point, ON_wString string );
  static bool GetPlugInUserData( const CRhinoObject* object, ON_3dPoint& point, ON_wString& string );
  static bool RemovePlugInUserData( CRhinoDoc& doc, const CRhinoObject* object );
