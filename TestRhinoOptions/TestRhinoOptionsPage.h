...
class CTestRhinoOptionsPage : public CRhinoOptionsDialogPage
{
	DECLARE_DYNAMIC(CTestRhinoOptionsPage)

public:
	CTestRhinoOptionsPage(CWnd* pParent = NULL);
	virtual ~CTestRhinoOptionsPage();
