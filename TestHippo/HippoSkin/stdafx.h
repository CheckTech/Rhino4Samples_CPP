...
// Rhino skins must always use the release MFC that Rhino uses.
// Rhino skins that require debugging information need to be built
// with RHINO_DEBUG_SKIN defined.
#if defined(RHINO_DEBUG_SKIN) && defined( _DEBUG )
// V4 PseudoDebug skin should define RHINO_DEBUG_SKIN, 
// but not define _DEBUG in the .vcproj file.
#error Do not define _DEBUG - use RHINO_DEBUG_SKIN instead
#endif
