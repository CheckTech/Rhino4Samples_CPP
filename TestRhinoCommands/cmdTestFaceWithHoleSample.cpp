...
////////////////////////////////////////////////////////////////
//
// BEGIN TestFaceWithHole command
//
...
static int MakeOuterTrimmingLoop(  ON_Brep& brep, // returns index of loop
...
static int MakeInnerTrimmingLoop(  ON_Brep& brep, // returns index of loop
     ON_BrepFace& face,  // face loop is on
...
class CCommandTestFaceWithHole : public CRhinoCommand
{
public:
	CCommandTestFaceWithHole() {}
  ~CCommandTestFaceWithHole() {}
	UUID CommandUUID()
	{
		// {B3B740FC-030A-42C1-A020-26903307B044}
    static const GUID TestFaceWithHoleCommand_UUID =
    { 0xB3B740FC, 0x30A, 0x42C1, { 0xA0, 0x20, 0x26, 0x90, 0x33, 0x7, 0xB0, 0x44 } };
    return TestFaceWithHoleCommand_UUID;
	}

  // Returns the English command name.
	const wchar_t* EnglishCommandName() { return L"TestFaceWithHole"; }

  // Returns the localized command name.
	const wchar_t* LocalCommandName() { return L"TestFaceWithHole"; }
...
static class CCommandTestFaceWithHole theTestFaceWithHoleCommand;

CRhinoCommand::result CCommandTestFaceWithHole::RunCommand( const CRhinoCommandContext& context )
{
