/////////////////////////////////////////////////////////////////////////////
// TestObjectPropertiesPageDlg.h

#pragma once

#include "Resource.h"

class CTestObjectPropertiesPageDlg : public CRhinoObjectPropertiesDialogPage
{
public:
	CTestObjectPropertiesPageDlg( UINT nID, CWnd* pParent = NULL );

  // Dialog Data
	enum { IDD = IDD_OBJPROPPAGE_DIALOG };
